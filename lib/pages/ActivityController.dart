...
class _ActivitiesScreenState extends State<ActivitiesScreen> {
  ...
  Future<void> _fetchActivities() async {
    ...
    try {
      ...
      setState(() {
        errorMessage = 'Error fetching activities: $e';
        isLoading = false;
      });
      _showErrorSnackBar(errorMessage!);
    }
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: isLoading
              ...
              : activities.isEmpty
              ? Center(child: Text('No activities found', style: TextStyle(color: isDarkTheme ? Colors.white70 : Colors.black54)))
              : ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  leading: Icon(Icons.event, color: isDarkTheme ? Colors.white : Color(0xFF2d3748)),
                  title: Text(
